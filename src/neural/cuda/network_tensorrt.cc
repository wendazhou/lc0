...
static const char* OUTPUT_POL_BLOB_NAME = "output_policy";
static const char* OUTPUT_VAL_BLOB_NAME = "output_value";
...
TensorRTNetwork::TensorRTNetwork(const WeightsFile& file,
    ...
    : runtime_(nullptr),
      ...
      engine_(nullptr),
      max_batch_size_(0) {
  max_batch_size_ = options.GetOrDefault<int>("max_batch", 256);
